guiLanguage.portugues = {
    ...
    -- GENERAL STRINGS
    --
    windowHeader = "Handling Editor VnB "..HVER.." r"..HREV,
	...
	disabledProperty = "Edição %s esta desabilitada pelo Server VDB!",
    ...
    menuinfo = {
        ...
        help = {
            ...
            longname = "Ajuda",
            itemtext = {
                textlabel = "Bem-vindo ao editor oficial de Handling VDB Server MTA! Este recurso permite que você edite a movimentação de qualquer veículo no jogo em tempo real. \n"..
                ...
                morelabel = "Obrigado por escolher o VDB Server, Quaisquer duvida acesse: evolserver.com!"
            }
        },
        reset = {
            shortname = "Resetar",
        ...
        upload = {
            shortname = "Upload",
            longname = "Upload sua Handling para o VnB Server."
        },
        download = {
            shortname = "Baixar (Download)",
            longname = "Baixar um conjunto de Handling do VnB Server."
        },
