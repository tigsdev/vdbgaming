...
function startShaderResource()
 ...
 skydome_shader = dxCreateShader ( "arquivos/efeitos/ceu/shaders/shader_skydome.fx",0,0,true,"object" )
 null_shader = dxCreateShader ( "arquivos/efeitos/ceu/shaders/shader_null.fx" )
 skydome_texture=dxCreateTexture("arquivos/efeitos/ceu/textures/skydome.jpg")
 ...
 txd_skybox = engineLoadTXD('arquivos/efeitos/ceu/models/skybox_model.txd')
 engineImportTXD(txd_skybox, modelID)
 dff_skybox = engineLoadDFF('arquivos/efeitos/ceu/models/skybox_model.dff', modelID)
