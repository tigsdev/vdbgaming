...
function enableContrast()
	...
	-- Shaders
	contrastShader = dxCreateShader( "arquivos/efeitos/contraste/contrast.fx" )
	bloomCombineShader = dxCreateShader( "arquivos/efeitos/contraste/bloom_combine.fx" )
	bloomExtractShader = dxCreateShader( "arquivos/efeitos/contraste/bloom_extract.fx" )
	blurHShader = dxCreateShader( "arquivos/efeitos/contraste/blurH.fx" )
	blurVShader = dxCreateShader( "arquivos/efeitos/contraste/blurV.fx" )
	modulationShader = dxCreateShader( "arquivos/efeitos/contraste/modulation.fx" )
	...
	-- Overlay texture
	textureVignette = dxCreateTexture ( "arquivos/efeitos/contraste/vignette1.dds" );
