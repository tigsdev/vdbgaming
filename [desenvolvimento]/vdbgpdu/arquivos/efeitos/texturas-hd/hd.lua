...
function enableDetail()
	...
	-- Load textures
	detail22Texture = dxCreateTexture('arquivos/efeitos/texturas-hd/detail22.png', "dxt3")
	detail58Texture = dxCreateTexture('arquivos/efeitos/texturas-hd/detail58.png', "dxt3")
	detail68Texture = dxCreateTexture('arquivos/efeitos/texturas-hd/detail68.png', "dxt1")
	detail63Texture = dxCreateTexture('arquivos/efeitos/texturas-hd/detail63.png', "dxt3")
	dirtyTexture = dxCreateTexture('arquivos/efeitos/texturas-hd/dirty.png', "dxt3")
	detail04Texture = dxCreateTexture('arquivos/efeitos/texturas-hd/detail04.png', "dxt3")
	detail29Texture = dxCreateTexture('arquivos/efeitos/texturas-hd/detail29.png', "dxt3")
	detail55Texture = dxCreateTexture('arquivos/efeitos/texturas-hd/detail55.png', "dxt3")
	detail35TTexture = dxCreateTexture('arquivos/efeitos/texturas-hd/detail35T.png', "dxt3")
...
function getMakeShader(v)
	...
	local shader,tec = dxCreateShader ( "arquivos/efeitos/texturas-hd/detail.fx", 1, 100 )
	if shader then
