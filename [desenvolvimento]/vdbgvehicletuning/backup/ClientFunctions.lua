...
addEventHandler("onClientRender", root,
    function()
	   	if MSG_SHOW then
	        ...
	        dxDrawText(fix(MSG_TXT), x, 122, 1002, 153, tocolor(0, 0, 0, 255), 1.00, "default", "center", "center", false, false, true, false, false)
	        dxDrawText(fix(MSG_TXT), x, 120, 1002, 151, tocolor(0, 0, 0, 255), 1.00, "default", "center", "center", false, false, true, false, false)
	        dxDrawText(fix(MSG_TXT), x, 122, 1000, 153, tocolor(0, 0, 0, 255), 1.00, "default", "center", "center", false, false, true, false, false)
	        dxDrawText(fix(MSG_TXT), x, 120, 1000, 151, tocolor(0, 0, 0, 255), 1.00, "default", "center", "center", false, false, true, false, false)
	        dxDrawText(MSG_TXT, x, 121, 1001, 152, tocolor(255, 255, 255, 255), 1.00, "default", "center", "center", false, false, true, true, false)
  		end 
    end
)
MSG_TIME = 5
	...
	if amount then
		...
		if money then
			if tonumber(money) >= tonumber(amount) then
				...
				exports.VDBGNotification_radar:showBox("#d9534f[ATENÇÃO]#ffffff Você não tem dinheiro suficiente!", 3000, localPlayer)
				return false
			end
		end
	end
