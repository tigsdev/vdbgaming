...
local lr1, lg1, lb1, lr2, lg2, lb2 = nil
...
--This is where the color updates every time you click the palette or presets!
	...
	closeSelect = function()
		closedColorPicker(true, colorPicker.value[1], colorPicker.value[2], colorPicker.value[3])
	end,
...
function openColorPicker()
	...
	lr1, lg1, lb1, lr2, lg2, lb2 = getVehicleColor(editingVehicle, true)
	if (editingVehicle) then
		colorPicker.openSelect(colors)
	end
end

function closedColorPicker(save,r,g,b)
	...
	triggerServerEvent("changeVehColor", getLocalPlayer(), getLocalPlayer(), editingVehicle, r1, g1, b1, r2, g2, b2)
	else
	setVehicleColor(editingVehicle, lr1, lg1, lb1, lr2, lg2, lb2)
	end
end
...
function updateColor()
	...
	dxDrawText("A kilépéshez kattints a képernyőre!\nHa meggondoltad magad nyomj a Kilépés gombra!", 0, 0, sx, sy, tocolor(200,100,100,255), 1.5, "normal", "center", "center")
end
