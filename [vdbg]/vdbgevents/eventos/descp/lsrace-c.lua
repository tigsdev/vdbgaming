...
addEvent ( "VDBGEvents:Modules->LSStreetRace:CreateCheckpoints", true )
addEventHandler ( "VDBGEvents:Modules->LSStreetRace:CreateCheckpoints", root, function ( f, d )
...
function ThisPlayerWinsRace  ( )
	triggerServerEvent ( "VDBGEvents:Modules->LSRace:ThisPlayerWinsRace", localPlayer )
end