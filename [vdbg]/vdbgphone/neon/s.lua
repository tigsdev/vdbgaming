...
addEventHandler( "cardamage", getRootElement(),
 function ( theVehicle, thePlayer )
   if isVehicleDamageProof(theVehicle) == true then
   setVehicleDamageProof(theVehicle, false)
		outputChatBox ( "#FFA500[CELULAR] #ffffffVocê desblindou seu veículo.",thePlayer, 255,255,255, true )
   else
   setVehicleDamageProof(theVehicle, true)  
		outputChatBox ( "#FFA500[CELULAR] #ffffffVocê blindou seu veículo.",thePlayer, 255,255,255, true )
   end
end )