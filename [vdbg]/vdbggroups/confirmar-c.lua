...
confirm.yes = guiCreateButton(sx*10, sy*100, sx*108, sy*25, "Confirma", false, confirm.window)
confirm.no = guiCreateButton(sx*128, sy*100, sx*108, sy*25, "Negar", false, confirm.window)
